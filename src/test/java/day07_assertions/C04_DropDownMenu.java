...
public class C04_DropDownMenu {
    ...
    public void test() throws InterruptedException {
        ...
        // 2-Select objesi olustur parametre olarak dropdownmenu
        Select select=new Select(dropDownMenu);
        //3- Dropdown da var olan optionlardan bir taneyi sec
        select.selectByVisibleText("Books");
        //select.selectByIndex(5);
        //select.selectByValue("//select[@id='searchDropdownBox']");


        // arama cubuguna java yazdiralim
